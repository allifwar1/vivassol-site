  ...
  return (
    <footer className="bg-ink text-white/70 pt-16 pb-10">
      <div className="max-w-[1280px] mx-auto px-6 md:px-10">
        <div className="grid md:grid-cols-[1.4fr_1fr_1fr] gap-12">
          <div>
            ...
            <p className="mt-5 max-w-sm leading-relaxed">
              Cada detalhe brilha mais com a Vivassol. Fábrica de personalizados feita de afeto e capricho.
            </p>
            <div className="flex items-center gap-3 mt-6">
              <a
                href="https://instagram.com/vivassol.com.br"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-white font-medium px-4 py-2.5 rounded-full hover:opacity-90 transition"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: "/presentes", label: "Canecas" },
                { href: "/presentes", label: "Camisetas" },
                { href: "/presentes", label: "Presentes" },
                { href: "/presentes", label: "Polaroides" },
              ].map((l) => (
                <li key={l.label}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                <PinIcon /> Monte Carmelo e Região
              </li>
              <li className="flex items-center gap-2">
                <TruckIcon /> Enviamos para todo o Brasil
              </li>
              <li className="flex items-center gap-2">
                <WppIcon /> Pedidos pelo WhatsApp
              </li>
            </ul>
          </div>
        </div>
        ...
        <div
          className="h-px my-10 rounded-full opacity-40"
